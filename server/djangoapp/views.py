...
def get_dealer_details(request, dealer_id):
    context = {}
    if request.method == "GET":
        url = 'https://c735cad8.us-south.apigw.appdomain.cloud/api/review'
...
def add_review(request, dealer_id):
    if request.method == "GET":
        dealersid = dealer_id
        url = "https://c735cad8.us-south.apigw.appdomain.cloud/api/dealership?dealerId={0}".format(dealersid)
        # Get dealers from the URL
        context = {
    ...
    if request.method == "POST":
        if request.user.is_authenticated:
            ...
            print (json_payload)
            url = "https://c735cad8.us-south.apigw.appdomain.cloud/api/reviews"
